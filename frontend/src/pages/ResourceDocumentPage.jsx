  ...
  if (!doc) {
    const msg =
      loadError === "forbidden"
        ...
        : loadError === "notfound"
          ? "Document not found. It may have been deleted, or the link may be wrong — open it from AGC Member Portal → Resources → Documents for the correct facility and category."
